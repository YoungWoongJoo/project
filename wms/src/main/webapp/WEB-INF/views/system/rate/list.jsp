...
uri="http://java.sun.com/jsp/jstl/core"%>
     ...
     <c:forEach var="storageRateVO" items="${storageRateList}">
     //일반창고 보관료 요율 설정이 있을경우
        ...
        tab_tr= $("#normal_warehouse_table tr");
          ...
          //저온창고 보관료 요율 설정이 있을경우
          else if("${storageRateVO.warehouse_rating}"!="" &&"${storageRateVO.warehouse_rating}"=="저온")
          {
