...
<html>
  ...
  <body>
    ...
    <form id="frm_systemSetting" method="POST" action="${contextPath}/system/setting/add.do">
      ...
      자치단체장 직급 : <input type="text" name="setting_chief_rank" required autocomplete="off" /><br />
      자치단체장 성함 : <input type="text" name="setting_chief_name" required autocomplete="off" /><br />
      양곡관리관 직급 : <input type="text" name="setting_manager_rank" required autocomplete="off" /><br />
      양곡관리관 성함 : <input type="text" name="setting_manager_name" required autocomplete="off" /><br />
